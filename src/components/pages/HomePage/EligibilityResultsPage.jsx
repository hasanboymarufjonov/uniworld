 ...
 * This version uses a grid layout for a cleaner separation of image and content.
 */
      ...
      <div className="bg-gray-50 min-h-screen flex flex-col justify-center items-center text-center p-6">
        <div className="max-w-md">
          ...
          <p className="font-sans mt-4 text-lg text-gray-600">
            {t(
              "We couldn't find any university matches based on your criteria, or you have accessed this page directly."
            )}
          </p>
          <Link to="/">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="font-heading text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900">
            {t("Your University Matches")}
          </h1>
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            {t(
              "Based on your profile, here are the universities we recommend for you."
            )}
          </p>
        </div>
